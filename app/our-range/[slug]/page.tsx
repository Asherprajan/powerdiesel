...
const brands: Record<string, BrandData> = {
  ...
  "komatsu": {
    ...
    image: "/komatsu.jpg",
    description: ` 
      <p class="mb-4">As a leading supplier of quality replacement machinery parts,PDEE stock and distribute spare parts for Komatsu Earthmoving and Mining Machines. Whether you are looking to service, or fully repair your machinery, our Komatsu aftermarket parts provide a high quality, low cost-option through our one stop shop.</p>
  ...
  "volvo": {
    ...
    description: `
      ...
      <p class="mb-4">As significant players in the construction sector, making sure existing vehicles continue to run safely and efficiently is of the utmost importance to any construction site. Power Diesel Engineering and equipment trading proudly supplies and distributes a range of high-quality replacement parts for Volvo Construction Equipment (Volvo CE), making sure that all vehicles are repaired and maintained with longevity in mind.</p>
  ...
  "cummins": {
    ...
    description: `
      ...
      <p class="mb-4">For over 20 years,Power Diesel Engineering and equipment trading has been the one-stop-shop for Cummins replacement engine parts. With the complete Cummins range covered, we're here to help our customers find the perfect replacement part at the right price. Our range covers:</p>
  ...
  "deutz": {
    ...
    description: `
      ...
      <p class="mb-4">As a leading supplier of replacement engine parts, here at Power Diesel Engineering and equipment trading we offer a full line of high-quality aftermarket parts for Deutz engines including:</p>
  ...
  "fg-wilson": {
    ...
    description: `
      ...
      <p class="mb-4">With over 20 years of expertise supplying the finest replacement parts for construction and power-generation equipment, Power Diesel Engineering and equipment trading is your one-stop-shop for finding the complete package at the right price. We can offer a full line of FG Wilson generator parts, including Perkins and Leroy Somer components, as well as many other leading brands to customers worldwide.</p>
